...
client_ask: >-
  Kedar Thakar is a **Principal Value Consultant** at a Leading Telecom Vendor, a company with
  more than 100,000 employees and one of the leading providers of Information
  and Communication Technology to service providers, with over 40% of the
  world’s mobile traffic carried through their networks. He is responsible for
  modeling the value of Companys’s solutions to customers.
  ...
  model changes and active collaboration with the clients. When Company’s
...
aside:
  - content: '![Company Logo](/img/logo_small.png)'
...
After receiving the initial spreadsheet from Kedar, company’s account managers would discuss it (in meetings) or send it to clients who would make the changes in their copy, send it back to account managers who could add more changes before sending it back to Kedar for review. 
...
During meetings with the customers, Account Managers were often asked questions like _“can you tell me what happens if we do not get x% but y% improvement thank to your solution?”_. **Answering meant going back to the model to update and test it, redraw charts and update slides.** By the time Company provided answers, the customer had prepared new questions. Back to square one.
...
Visyond allowed Company to quickly build reliable models, perform analyses on-the-fly, securely share spreadsheets and effectively communicate with the customers in a **controlled environment** where stakeholders can model and **test assumptions seeing and interacting with only what they need/can see** while leaving the underlying core logic intact.
...
With Visyond, Company formed **a knowledge base that can be accessed anywhere at any time** and contains all changes, scenarios, supporting documentation and conversations. It made tracking inputs and identifying their origins simpler as well as removed the need to manage multiple versions of the same spreadsheet.
...
Therefore, there is **no longer a need to manually maintain separate presentation layers on top of the spreadsheet** as Visyond can instantaneously adjust to changes in input, output or layout without requiring any development effort from Company.
