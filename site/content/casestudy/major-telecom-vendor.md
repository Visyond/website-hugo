...
# AND - The Excel model had to be encoded into a web app to help clients test assumptions independently
...
# AND - Keeping visualizations in sync with models was troublesome
