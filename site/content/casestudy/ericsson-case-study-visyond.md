...
summary:
  - content: "* Complicated workflow with many stakeholders.\r\n* Modeler was the main bottleneck.\r\n* The Excel model had to be encoded into a web-app to help clients test scenarios independently.\r\n* Analysis setup was manual and time-consuming.\r\n* It was hard to answer ‘what-if’ questions in real time.\r\n* Keeping visualizations up-to-date with the spreadsheet was problematic.\r\n* It was hard to track changes and supporting documentation.\r\n* Spreadsheet audit and error detection was time-consuming.\r\n"
    title: Challenge
  - content: "* Secure and collaborative cloud-based platform for modeling and scenario testing.\r\n* Structured and controlled information flow using built-in data tracking functionality.\r\n* Powerful and easy-to-use auditing tools that reduce risk of errors and save time debugging the model.\r\n* Automated analytics with single-click autoanalysis.\r\n* Secure interactive web dashboards for self-service scenario testing.\r\n* Role- and object-based access management to safeguard the model, analyses, and reports.\r\n"
    title: Solution
  - content: "* Significant productivity boost.\r\n* Stakeholders can see and interact only with what they are allowed to, reducing the risk of accidental changes and data leaks.\r\n* Modeler is no longer a bottleneck since stakeholders can securely self-serve on the model, analyses, and scenarios.\r\n* The cloud-based platform helped establish a single source of truth and made collaboration much easier, solving the ‘version chaos’.\r\n* Error and anomaly detection is faster and easier.\r\n* Analyses can be set up in minutes and are always up-to-date.\r\n* Stakeholders are empowered to safely test scenarios through spreadsheet-driven interactive dashboards and calculators.\r\n\n"
    title: Results
study_intro: >-
...
## Without Visyond, Workflow Was Complicated
...
## Without Visyond, Modeler Was the Main Bottleneck
...
## Without Visyond, Information was Hard to Retrieve
...
## Without Visyond, Debugging was Painful
...
## Without Visyond, All 'What-if' Analysis and Stress-testing was Manual and Time Consuming
...
## Without Visyond, It was Impossible to Answer ‘What-if’ Questions On-The-Fly
...
## Without Visyond, the Excel model Had to Be Encoded Into a Web App to Help Clients Test Assumptions Independently
...
## Without Visyond, Keeping Visualizations in Sync with Models Was Troublesome
